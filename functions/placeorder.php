<?php
    ...
    if(isset($_SESSION['auth']))
    {
        ...
        if(isset($_POST['placeOrderBtn']))
        {
            ...
            $tracking_no = "GAMEZONE".rand(1111,9999).substr($phone,2);
            ...
            if($insert_query_run)
            {
                ...
                foreach ($query_run as $citem)
                {
                    ...
                    $updataQty_query = "UPDATE products SET qty='$new_qty' WHERE id='$prod_id' ";
                    $updataQty_query_run = mysqli_query($con, $updataQty_query);
