                ...
                <form action="code.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                                ...
                                <textarea rows="3" name="small_description" placeholder="Enter small Desciption" class="form-control mb-2"></textarea>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" name="meta_description" placeholder="Meta Description" class="form-control mb-2"></textarea>
                        </div>
                        <div class="col-md-12">
                            <label class="mb-0">Meta Keywords</label>
                            <textarea rows="3" name="meta_keywords" placeholder="Meta Keywords" class="form-control mb-2"></textarea>
                        </div>
                        <div class="col-md-12">
                            <button type="submit" required class="btn btn-primary" name="add_product_btn">Save</button>
                        </div>
                    </div>
                </form>
                </div>
