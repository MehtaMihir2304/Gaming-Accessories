                ...
                <form action="code.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" name="meta_description" placeholder="Meta Description" class="form-control"></textarea>
                        </div>
                        <div class="col-md-12">
                            <label for="">Meta Keywords</label>
                            <textarea rows="3" name="meta_keywords" placeholder="Meta Keywords" class="form-control"></textarea>
                        </div>
                        <div class="col-md-6">
