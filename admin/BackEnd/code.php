...
if(isset($_POST['add_category_btn']))
{
    ...
    if($cate_query_run)
    {
        ...
        redirect("add-category.php", "Cateegory Added Successfully");
...
else if(isset($_POST['delete_category_btn']))
{
    ...
    if($delete_query_run)
    {
        ...
        redirect("category.php", "Category delected Successfully");
        echo 200;
    }
    else
    {
...
else if(isset($_POST['add_product_btn']))
{
    ...
    {
        redirect("add-product.php", "All fileds are mandatory");
...
else if(isset($_POST['update_order_btn']))
{
    ...
    $update_query_run = mysqli_query($con, $updateOrder_query);

    redirect("view-order.php?t=$track_no", "Order Status Update");
